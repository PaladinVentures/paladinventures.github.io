...
class modJSHeaderMenuHelper {
    ...
    function ShowMenu() {
        ...
        $jsheadermenu 	= $jsapp->getMenu();        
        
		$end = $this->params->get('endLevel',0);
		
        //get menu items        
        $rows 	= $jsheadermenu->getItems('menutype', $this->name);
    ...
    function getActive() {
        ...
        $jsapp	= JFactory::getApplication();
		$jsheadermenu	= $jsapp->getMenu();
		$active	= $jsheadermenu->getActive();
		$active_id = isset($active) ? $active->id : $jsheadermenu->getDefault()->id;
