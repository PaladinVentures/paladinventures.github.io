...
$(window).load(function() {
  ...
  itemSelector.parent().find('.parallax-numbers-text').transition({top: 0, opacity: 1, delay: index*100}, 200);
  ...
  $this.children('img').transitionStop().css({transformOrigin: imgOriginX + ' ' + imgOriginY}).transition({scale: 1.5, rotate: '0.02deg'}, 7000);
  else
  $this.children('img').transitionStop().css({transformOrigin: imgOriginX + ' ' + imgOriginY}).transition({scale: 1.5}, 7000);
  });
  ...
  if (/mozilla/.test(navigator.userAgent.toLowerCase()))
  $this.children('img').transitionStop().transition({scale: 1, rotate: '0deg'}, 7000);
  else
  $this.children('img').transitionStop().transition({scale: 1}, 7000);
  });
  ...
  $('.portfolio-item').each(function() { $(this).removeClass('selected'); });
  selector.addClass('selected');

  $('#portfolio-full-item-holder').mCustomScrollbar('scrollTo', 0, {scrollInertia: 400})
  .fadeOut(400, function() {  changePortfolioFull(selector);  })
  .fadeIn(400);
  ...
  $('#portfolio-full-item-holder').mCustomScrollbar('scrollTo', 0, {scrollInertia: 400})
  .fadeOut(400, function() {  changePortfolioFull(nextSelector);  })
  .fadeIn(400);
  });
  ...
  $this.parent().find('.filter-button').each(function() { $(this).removeClass('button-active'); });
  ...
  var $this = $(this);
  $this.find('.transparent-frame').stop().transition({opacity: 0.2}, 300);

  $this.find('.team-item-icons').find('a').each(function(index) {
  $(this).stop(true, true).transition({top: 0, opacity: 1, delay: index*100}, 200);
  });
  });

  $(document).on('mouseleave', '.team-item-image', function() {
  var $this = $(this);
  $this.find('.transparent-frame').stop().transition({opacity: 0.6}, 300);

  $this.find('.team-item-icons').find('a').each(function(index) {
  $(this).stop(true, true).transition({top: 40, opacity: 0, delay: index*100}, 200);
  });
  });
  ...
  selectorImage.stop(true, true).transition({opacity: 1}, 200);
  selectorIcon.stop(true, true).animate({marginTop: 0}, 200, 'linear');
  $this.find('h4, h5').animate({top: selectorIcon.parent().height()}, 200, 'linear');
  });
  ...
  selectorImage.stop(true, true).transition({opacity: 0}, 200);
  selectorIcon.stop(true, true).animate({marginTop: -selectorIcon.parent().height()}, 200, 'linear');
  $this.find('h4, h5').animate({top: 0}, 200, 'linear');
  });
  ...
  $this.find('.transparent-frame').stop(true, true).transition({opacity: 0.2}, 400);
  $this.find('h4').stop(true, true).transition({left: leftValue}, 400);
  $this.find('.blog-item-date').stop(true, true).transition({right: rightValue}, 400);
  });

  $(document).on('mouseleave', '.blog-item-inner', function() {
  var $this = $(this);

  $this.find('.transparent-frame').stop(true, true).transition({opacity: 0.6}, 400);
  $this.find('h4').stop(true, true).transition({left: 30}, 400);
  $this.find('.blog-item-date').stop(true, true).transition({right: 30}, 400);
  });
  ...
  $('#testimonials-dots-holder').find('.testimonials-dot').each(function() { $(this).removeClass('testimonials-active-dot').addClass('testimonials-inactive-dot'); });
  ...
  $this.find('.clients-background').transitionStop(true, true).css({transformOrigin: imgOriginX + ' ' + imgOriginY}).transition({scale: 1.2}, 400);
  $this.find('.clients-logo-clone').animate({top: 0}, 200, 'linear');
  $this.find('.clients-logo:not(.clients-logo-clone)').animate({top: '100%'}, 200, 'linear');
  });
  ...
  $this.find('.clients-background').transitionStop(true, true).transition({scale: 1}, 400);
  $this.find('.clients-logo-clone').animate({top: '-100%'}, 200, 'linear');
  $this.find('.clients-logo:not(.clients-logo-clone)').animate({top: 0}, 200, 'linear');
  });
  ...
  $('.services-item-hover h3').each(function() { $(this).animate({marginTop: -$(this).parent().height()}, 100); });
  $('#testimonials-item-inner').css({'width': $('#testimonials-item-inner .testimonials-item').length * 100 + '%', 'height': $('#testimonials-item-inner .testimonials-item').height() + 'px'});
  ...
  $('.clients-logo').each(function() { var $this = $(this); $this.clone().addClass('clients-logo-clone').appendTo($this.parent()); });

  $('#portfolio-full-item-holder').mCustomScrollbar({theme: '3d', mouseWheel: {scrollAmount: 400}});
  testimonialsTimeout = setTimeout(function() { testimonialsAnimate(1, testimonialsNumberOfItems); }, 10000);
  headerTimeout = setTimeout(function() { headerAnimate(1, headerNumberOfItems); }, 10000);
  ...
  $('#navigation-menu').find('a').each(function() { $(this).parent().css('top', '0px'); });
  ...
  $('#testimonials-item-inner').stop(true, true).transition({x: translateX}, 400, function() {
  clearTimeout(testimonialsTimeout);
  testimonialsTimeout = setTimeout(function() {testimonialsAnimate((testimonialsIndex + 1) % testimonialsNumberOfItems, testimonialsNumberOfItems); }, 10000);
  });
  }
