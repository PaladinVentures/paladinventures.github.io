...
?>
    ...
    <div id="contact-form">
        <form name="contactform" id="form" method="post" action="<?php $_SERVER['PHP_SELF']?>">
           ...
           <div class="row">
			 <div class="col-md-6 col-sm-6">  
             <input class="text form-control" placeholder="Phone" name="phno" type="text" value="<?php echo $phno; ?>" />
             </div>
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
                <tr>
                    <td width="100%" style="float:left;" valign="top">
                     <p>
                        <input type="submit" class="btn" name="submit" value="<?php echo JText::_('MOD_JDCONTACT_SUBMIT'); ?>" id="submit" />
                     </p>
                    </td>
